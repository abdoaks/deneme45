...
exports.run = async (client, message, args) => {
  if(!args[0]) return message.reply('𝘾𝙊𝙍𝙊𝙉𝘼 𝙑𝙄𝙍𝙐𝙎 𝘼𝙉𝙇𝙄𝙆 𝙄𝙎𝙏𝘼𝙏𝙄𝙎𝙏𝙄𝙆 𝙏𝘼𝘽𝙇𝙊𝙎𝙐 𝙆𝙐𝙇𝙇𝘼𝙉𝙄𝙈```Güncel Covid-19 vaka istatistiklerini buradan görebilirsin. Ülkeye özel istatistikler için mb!korona <ülke kodu> komutunu kullanabilirsin. #evdekal```**Doğru Kullanım:** __mb!korona <ülke kodu>__')
  ...
  let ülk = body.countrydata[0].info.title
    ...
    .setTimestamp()
    .setFooter('MaximusBoys | COVID-19 İstatistik', client.user.avatarURL);
